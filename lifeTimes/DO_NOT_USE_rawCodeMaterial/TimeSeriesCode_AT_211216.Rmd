...
output: html_notebook
---
#Remove and add git repo instructions
...
# Define function (a Loop to run data through ccf function)
...
```
#From output of CCF function,
#Cluster data by mean correlation at lag 0

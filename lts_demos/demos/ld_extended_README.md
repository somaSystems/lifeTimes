...
lts_in(.in_tsData = rain_flow, #1. the dataset
         .in_time = "dayOfseason", #2. the time column
       ...
       .in_pairedComparisons = lts_pairedVars, #5. A list of lisys, holding the pairs of variables to be compared
       .in_uniqueID_colname = , #6. The column with unique ID name for your observations

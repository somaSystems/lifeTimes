...
<p>
![Fig 1A: example of clusterPlot(), output](README_figs/clusterPlots.png){width=60%}  
<p>
<p>
...
<p> 
![Fig 2: example of leadLagClusterPlot(), output](README_figs/leadLagPlot.png){width=50%}  
...
<p>
![Fig 3: example of couplingPlot(), output](README_figs/couplingPlot.png){width=40%}  


**Fig 4** Ariel images of the Ash, and Thames rivers.  

![Fig 4: example of couplingPlot(), output](README_figs/riverCatchments.png){width=60%}  

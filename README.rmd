...
<p>
![Fig 1: An example of clusterPlot(), output](README_figs/README-clusteredCorrelations.png){width=50%}

**Fig 2** Calculated asymmetries between past and future lags, clustered by strength of asymmetry\
<p>
![Fig 2: An example of leadLagClusterPlot(), output](README_figs/README-clusteredCorrelationLags.png){width=50%}

**Fig 3** 'Coupling plots' representing the strength of correlation at lag zero, and the direction of correlation.\
<p>
![Fig 3: An example of couplingPlot(), output](README_figs/README-couplingPlot.png){width=50%}

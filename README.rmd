...
**How to use**\
Currently, just source, assign, and call the  `` `r "\u0060r outputCCF <- timesChain()\u0060"` `` function,\
this will chain together the lifeTimes workflow on a built in set of default data.

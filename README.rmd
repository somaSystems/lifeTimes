...
\
![an image caption Source: Ultimate Funny Dog Videos Compilation 2013.](README_figs/README-clusteredCorrelations.png)

**Fig 2** Calculated asymmetries between past and future lags, clustered by strength of asymmetry\
\
![an image caption Source: Ultimate Funny Dog Videos Compilation 2013.](README_figs/README-clusteredCorrelationLags.png)
<br>
**Fig 3** 'Coupling plots' representing the strength of correlation at lag zero, and the direction of correlation.\
\
![an image caption Source: Ultimate Funny Dog Videos Compilation 2013.](README_figs/README-couplingPlot.png)

...
**Fig 2** Calculated asymmetries between past and future lags, clustered by strength of asymmetry <br>
<p> 
![Fig 2: example of leadLagClusterPlot(), output](README_figs/README-clusteredCorrelationLags.png){width=50%}

**Fig 3** 'Coupling plots' representing the strength of correlation at lag zero, and the direction of correlation. <br>
<p>
